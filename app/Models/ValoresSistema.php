...
class ValoresSistema extends Model
{
    use HasFactory, HasUuids, SoftDeletes;
    protected $table = "ValoresSistema"; #Se indica el nombre de la tabla    
    ...
    protected $fillable = ['Cve','Descripcion','Tipo','ParamStr','ParamInt',
