...
class ProcesoSteps extends Model
{
    use HasFactory, HasUuids, SoftDeletes;
    protected $table = "ProcesoSteps"; #Se indica el nombre de la tabla    
    ...
    protected $fillable = ['uuidProceso','Cve','Nombre','Descripcion','Ordenamiento',
