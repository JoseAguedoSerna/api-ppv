...
class ValoresGlobales extends Model
{
    use HasFactory, HasUuids, SoftDeletes;
    protected $table = "ValoresGlobales"; #Se indica el nombre de la tabla    
    ...
    protected $fillable = ['Modulo', 'Cve','Descripcion','Tipo','ParamStr','ParamInt','ParamFloat',
