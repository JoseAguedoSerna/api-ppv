...
class Citas extends Model
{
    ...
    protected $table = "Citas"; #Se indica el nombre de la tabla    
    ...
    protected $fillable = ['Asunto','NoResguardo','NomResguardante','Descripcion','Departamento','FechaProgramada','HoraProgramada','Status',
